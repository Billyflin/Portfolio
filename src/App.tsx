      ...
      cases: [
        {
          ...
          evidence: [
            ...
            'Independent public CAP/Fiori reference with 11 service tests covering role authorization and resilient OData integration, plus green CI',
          ],
