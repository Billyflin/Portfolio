    ...
    work: {
      ...
      cases: [
        ...
        },
        {
          ...
          href: 'https://github.com/Billyflin/ufro-sustentable',
        },
      ],
    },
    experience: {
    ...
    work: {
      ...
      cases: [
        ...
        },
        {
          ...
          tags: ['Kotlin', 'Android', 'Firebase', 'BDD', 'Cucumber'], tone: 'paper', label: 'Ver repositorio', href: 'https://github.com/Billyflin/ufro-sustentable',
        },
      ],
    },
    experience: {
