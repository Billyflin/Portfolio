...
const pages = {
  en: {
    ...
    evidence: [
      ...
      ['SAP CAP/Fiori public reference', 'Open SAP BTP reference with CDS modeling, OData V4, Fiori Elements, XSUAA/HANA deployment design, and 11 CAP service tests covering role authorization and degraded external OData behavior; lint, production build, and GitHub Actions CI pass.'],
  ...
  es: {
    ...
    evidence: [
      ...
      ['Referencia pública SAP CAP/Fiori', 'Referencia abierta de SAP BTP con modelado CDS, OData V4, Fiori Elements, diseño de despliegue XSUAA/HANA y 11 pruebas CAP sobre autorización por roles y degradación de un servicio OData externo; lint, build productivo y CI pasan.'],
