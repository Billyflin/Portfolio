...
export function FallingPattern({ color = 'var(--primary)', backgroundColor = 'var(--background)', duration = 150, blurIntensity = '1em', density = 1, className, }) {
    ...
    return (_jsxs("div", { className: cn('relative h-full w-full p-1', className), children: [_jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.2 }, className: "size-full", children: _jsx(motion.div, { className: "relative z-0 size-full", style: {
                        backgroundColor,
                    ...
                    }, initial: "initial", animate: "animate" }) }), _jsx("div", { className: "absolute inset-0 z-[1] dark:brightness-[6]", style: {
