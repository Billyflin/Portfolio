...
export function Waves({ className = '', strokeColor = '#ffffff', backgroundColor = '#000000', pointerSize = 0.5, }) {
    ...
    return (_jsxs("div", { ref: containerRef, className: `waves-component relative overflow-hidden ${className}`, style: {
            backgroundColor,
            position: 'absolute',
            top: 0,
            left: 0,
            ...
            ['--x']: '-0.5rem',
            ['--y']: '50%',
        }, children: [_jsx("svg", { ref: svgRef, className: "block h-full w-full", xmlns: "http://www.w3.org/2000/svg" }), _jsx("div", { className: "pointer-dot", style: {
                    position: 'absolute',
                    top: 0,
                    left: 0,
